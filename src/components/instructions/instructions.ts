...
`,
	...
	`,
	beforeStudy: `
	Po kliknięciu "dalej" rozpocznie się sesja eksperymentalna. Informacja zwrotna po odpowiedziach nie będzie wyświetlana. Poziom trudności będzie losowy. Na koniec zostaną wyświetlone trzy (po jednym na każdy stopień trudności) formularze sprawdzające, jak trudne dla ciebie było to zadanie.
	`,
	beforeTLX: `
	Po kliknięciu "dalej" przejdziesz do formularzy. Odnoszą się do serii zadań, którą właśnie zakończyłeś. Każdy formularz odpowiada jednemu z trzech stopni trudności (z drugim kolorowym kołem, z gradientami na suwakach lub same wartości liczbowe).
	`,
	beforeRGB: `
